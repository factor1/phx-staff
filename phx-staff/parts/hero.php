...
if (has_post_thumbnail()) {
  if (have_posts()) {
    while (have_posts()) {
      ...
      $thumbUrl = wp_get_attachment_image_src($thumbId, true); // grab the URL of the featured image. Can assign its size also as the 2nd parameter ($thumbID, 'thumbnail-size', true)
?>
